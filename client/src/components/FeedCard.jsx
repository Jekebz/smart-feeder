  ...
  return (
    <section className="feed-panel rounded-[16px] bg-feed px-[26px] py-[55px] shadow-soft">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h3 className="font-inter text-[18px] font-extrabold text-ink">Feed Jowok</h3>
          <p className="mt-1 font-inter text-[13px] font-medium text-ink">Give a meal now</p>
          <p className="mt-2 max-w-[140px] font-inter text-[12px] font-medium leading-tight text-[#8A625B]">
            Manual feeding outside schedule
          </p>
        </div>
      </div>

      <div className="my-[43px] h-px w-full bg-white/80" />
      ...
      <button
        onClick={feedNow}
        className="feed-button mt-[32px] h-[59px] w-full rounded-[20px] font-inter text-[16px] font-bold text-white shadow-[0_5px_4px_rgba(0,0,0,.18)]"
      >
